        ...
        <View style={[styles.container, { justifyContent: 'center' }]}>
            <View style={styles.authCard}>
                ...
                <View style={{ marginBottom: 15 }}>
                    <Text style={{ marginBottom: 5, fontWeight: '500', color: '#0F172A' }}>Nom d'utilisateur</Text>
                    <TextInput 
                ...
                <View style={{ marginBottom: 20 }}>
                    <Text style={{ marginBottom: 5, fontWeight: '500', color: '#0F172A' }}>Mot de passe</Text>
                    <TextInput 
                        style={[styles.input, { marginBottom: 0 }]} 
                        placeholder='••••••••'
                ...
                {errorMsg ? <Text style={[styles.ErrorText, { textAlign: 'center' }]}>{errorMsg}</Text> : null}
